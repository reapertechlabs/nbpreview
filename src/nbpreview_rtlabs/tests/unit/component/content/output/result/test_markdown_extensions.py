"""Test for nbpreview_rtlabs.component.content.output.result.markdown_extensions."""
import pytest
from markdown_it import token
from pytest_mock import MockerFixture

from nbpreview_rtlabs.component.content.output.result import markdown_extensions
...
def test_unknown_token_type_error(mocker: MockerFixture) -> None:
    ...
    mocker.patch(
        "nbpreview_rtlabs.component.content.output.result.markdown_extensions._group_tokens",
